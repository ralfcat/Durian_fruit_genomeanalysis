...
# Create local AUGUSTUS config directory and set permissions
mkdir -p /home/victoe/augustus_config/species
chmod a+w -R /home/victoe/augustus_config/species/

# Copy the GeneMark key to home directory
...
# Setup environment variables for AUGUSTUS
...
braker.pl \
    ...
    --cores=8 \
    --workingdir=$OUT_DIR \
    --AUGUSTUS_CONFIG_PATH=/home/victoe/augustus_config \
